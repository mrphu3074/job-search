$(document).ready(function() {
  ...
  var SEARCH_ONLY_API_KEY = '542af25db3bf09980458a9675e27517b';
  var INDEX_NAME = 'techworks';
  var PARAMS = {
    hitsPerPage: 20,
    maxValuesPerFacet: 10,
    facets: ['type'],
    disjunctiveFacets: ['locations', 'jobLevel', 'tags', 'company']
  };
  var FACETS_SLIDER = ['price'];
  var FACETS_ORDER_OF_DISPLAY = ['locations', 'jobLevel', 'tags', 'company'];
  var FACETS_LABELS = {locations: 'Locations', jobLevel: 'Level', tags: 'Skills', 'company': 'Company'};
